    ...
    <section class='footerFix'>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-4">
            <h2>Past</h2>
            <p>I recently graduated from the University of Utah's full stack flex coding boot-camp. I learned things like React, Sql, noSql, graphQl, Node.js, Express.js, CSS, HTML and MongoDB. I'm still quite inexperienced compared to others within the industry of IT, but I have a desire to learn and build with a team! </p>
          ...
          <div class="col-md-4">
            <h2>Present</h2>
            <p>Currently I'm looking for work and still educating myself. Sources like CS50 from EdX, PluralSight, Udemy and TheOdinProject have been great resources as I continue to learn and grow.</p>
          </div>
          <div class="col-md-4">
            <h2>Future</h2>
            <p>I really like many of the designs and ideas behind Web3. The blockchain and decentralized currencies are incredibly interesting and I would love to achieve the knowledge and capability of being able to code things of this nature!</p>
